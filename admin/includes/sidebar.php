    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="attendance">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="add_attendance.php">Add Attendance</a></li>
                    <li class="nav-item"> <a class="nav-link" href="view_attendance.php">Attendance View</a></li>
                </ul>
            </div>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link" href="create_notification.php">
