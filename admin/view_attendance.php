            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
               <div class="modal-header">
                <h5 class="modal-title" style="float: left;">View Attendance</h5>
              </div>
              <div class="col-md-12 mt-4">
                ...
                <div class="row ">
                  ...
                  <button type="submit" style="float: left;" name="save" class="btn btn-primary mr-2 mb-4">View</button>
                </form>
              </div>
            </div>
          </div>
            ...
            <div class="card">
              ...
              <table class="table align-items-center table-flush table-hover table-bordered" id="dataTableHover">
                  ...
                  <tbody>
                    ...
                    $sql = "SELECT * FROM attendance WHERE attendance.student_name = :student_name";
