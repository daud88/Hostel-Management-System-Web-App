...
if (isset($_POST['save'])) {
  ...
  if ($LastInsertId > 0) {
    ...
    echo "<script>window.location.href ='create_notification.php'</script>";
  } else {
...
if (isset($_GET['del'])) {
  $id = intval($_GET['del']);
  $sql = "delete from notice where id=:cid";
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
               <div class="modal-header">
                <h5 class="modal-title" style="float: left;">Notice Board</h5>
              </div>
              <div class="col-md-12 mt-4">
                <form class="forms-sample" method="post" enctype="multipart/form-data" class="form-horizontal">
                  ...
                  <button type="submit" style="float: left;" name="save" class="btn btn-primary mr-2 mb-4">Add Notice</button>
                </form>
              </div>
            </div>
          </div>
          <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
              ...
              <table class="table align-items-center table-flush table-hover table-bordered" id="dataTableHover">
                  <thead>
                  <tr>
                      <th class='text-center' style='color: #ffffff; background-color: black;' colspan='5'><h2>Current Notices</h2></th>
                    </tr>
                    <tr>
                      ...
                      { 
                        ...
                        <tr scope="row">
                          ...
                          <td class=" text-center"><a href="#"  class=" edit_data4" id="<?php echo  ($row->id); ?>" title="click to edit"><i class="mdi mdi-pencil-box-outline" aria-hidden="true"></i></a>
                            <a href="create_notification.php?del=<?php echo $row->id;?>" data-toggle="tooltip" data-original-title="Delete" onclick="return confirm('Do you really want to delete?');"> <i class="mdi mdi-delete"></i> </a>
                          </td>
                        </tr>
                        <?php 
                        $cnt=$cnt+1;
