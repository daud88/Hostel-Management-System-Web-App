...
if (isset($_POST['submit'])) {
  ...
  $sql = "insert into  registration(roomno,seater,feespm,foodstatus,stayfrom,duration,course,regno,firstName,middleName,lastName,gender,contactno,emailid,egycontactno,guardianName,guardianRelation,guardianContactno,corresAddress,corresCIty,corresState,corresPincode,pmntAddress,pmntCity,pmnatetState,pmntPincode)values(:roomno,:seater,:fees,:foodstatus,:stayfrom,:duration,:course,:regno,:fname,:mname,:lname,:gender,:contactno,:emailid,:eno,:gurname,:gurrelation,:gurno,:caddress,:ccity,:cstate,:cpincode,:paddress,:pcity,:pstate,:ppincode)";
  ...
  $query->bindParam(':foodstatus', $foodstatus, PDO::PARAM_STR);
  $query->bindParam(':stayfrom', $stayfrom, PDO::PARAM_STR);
  ...
  $query->bindParam(':eno', $eno, PDO::PARAM_STR);
  $query->bindParam(':gurname', $gurname, PDO::PARAM_STR);
  $query->bindParam(':gurrelation', $gurrelation, PDO::PARAM_STR);
  $query->bindParam(':gurno', $gurno, PDO::PARAM_STR);
  $query->bindParam(':caddress', $caddress, PDO::PARAM_STR);
  $query->bindParam(':ccity', $ccity, PDO::PARAM_STR);
  $query->bindParam(':cstate', $cstate, PDO::PARAM_STR);
  $query->bindParam(':cpincode', $cpincode, PDO::PARAM_STR);
  ...
  $query->bindParam(':ppincode', $ppincode, PDO::PARAM_STR);
  $query->execute();
  $LastInsertId = $dbh->lastInsertId();
  if ($LastInsertId > 0) {
    echo '<script>alert("Registered successfully")</script>';
    echo "<script>window.location.href ='student_register.php'</script>";
  } else {
